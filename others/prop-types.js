      ...
      if(!n[o]){
        if(!t[o]){
          ...
          return n[o].exports
            ...
            var ReactPropTypesSecret = require('./lib/ReactPropTypesSecret');  //一个常量而已
            var checkPropTypes = require('./checkPropTypes'); //一个检查属性的异常报错函数
            ...
            module.exports = function(isValidElement, throwOnDirectAccess) {
               ...
               *   });
               *
               * A more formal specification(规则，规范) of how these methods are used:
               *
              ...
              var ANONYMOUS = '<<anonymous>>'; //不知姓名的; 名字不公开的; 匿名的; 不具名的; 没有特色的;
              ...
              function createChainableTypeChecker(validate) {
                ...
                // chainedCheckType 实际上就是checkType
              ...
              function createPrimitiveTypeChecker(expectedType) {
                function validate(props, propName, componentName, location, propFullName, secret) {
                  ...
                  if (propType !== expectedType) {
                    ...
                    // check, but we can offer a more precise（明确的） error message here rather than
                    // 'of type `object`'.
              ...
              function getPropType(propValue) {
                ...
                if (propValue instanceof RegExp) {  
                  //旧版webkit typeof 一个正则实例会返回function而不是object，所以这里统一成object
